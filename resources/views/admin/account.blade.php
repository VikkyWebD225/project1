                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="{{route('dashboard')}}" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Reports
                                </a>
        ...
        <div class="row tm-content-row tm-mt-big">
            ...
            <div class="tm-col tm-col-small">
                <div class="bg-white tm-block">
                    ...
                    <img src="public/adminpanel/img/profile-image.png" alt="Profile Image" class="img-fluid">
