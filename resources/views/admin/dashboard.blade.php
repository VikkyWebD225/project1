...
<head>
    ...
    <link rel="stylesheet" href="public/adminpanel/css/fontawesome.min.css">
    <!-- https://fontawesome.com/ -->
    <link rel="stylesheet" href="public/adminpanel/css/fullcalendar.min.css">
    <!-- https://fullcalendar.io/ -->
    <link rel="stylesheet" href="public/adminpanel/css/bootstrap.min.css">
    <!-- https://getbootstrap.com/ -->
    <link rel="stylesheet" href="public/adminpanel/css/tooplate.css">
</head>
                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-xl navbar-light bg-light">
                        <a class="navbar-brand" href="#">
                            <i class="fa-sharp fa-solid fa-user-hair fa-xs" style="color: #26354f;"></i>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto">
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{route('dashboards')}}">Dashboard
            ...
            <footer class="row tm-mt-small">
                <div class="col-12 font-weight-light">
                    <p class="d-inline-block tm-bg-black text-white py-2 px-4">
                        Copyright &copy; 2023 Admin Dashboard . Created by
                        <a rel="nofollow" href="https://www.tooplate.com" class="text-white tm-footer-link">Krishna Pratap Singh</a>
                    </p>
                </div>
            </footer>
        </div>
    </div>
    <script src="public/adminpanel/js/jquery-3.3.1.min.js"></script>
    <!-- https://jquery.com/download/ -->
    <script src="public/adminpanel/js/moment.min.js"></script>
    <!-- https://momentjs.com/ -->
    <script src="public/adminpanel/js/utils.js"></script>
    <script src="public/adminpanel/js/Chart.min.js"></script>
    <!-- http://www.chartjs.org/docs/latest/ -->
    <script src="public/adminpanel/js/fullcalendar.min.js"></script>
    <!-- https://fullcalendar.io/ -->
    <script src="public/adminpanel/js/bootstrap.min.js"></script>
    <!-- https://getbootstrap.com/ -->
    <script src="public/adminpanel/js/tooplate-scripts.js"></script>
    <script>
        let ctxLine,
            ctxBar,
            ctxPie,
